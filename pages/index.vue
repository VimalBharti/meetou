<template>
  ...
  <header class="sticky top-4 inset-x-0 flex flex-wrap md:justify-start md:flex-nowrap z-50 w-full">
    <nav class="relative max-w-[66rem] w-full shadow-xl bg-white rounded-2xl py-3 ps-5 pe-2 md:flex md:items-center md:justify-between  mx-2 lg:mx-auto" aria-label="Global">
  ...
  <main id="content">
    ...
    <div class="bg-white" id="home">
      <div class="max-w-5xl mx-auto px-4 xl:px-0 pt-24 lg:pt-32 pb-24">
        <h1 class="font-semibold text-gray-800 text-5xl md:text-6xl">
          <span class="text-cyan-600">MeetoU:</span> Transforming ideas into reality
        </h1>
        <div class="max-w-4xl">
          <p class="mt-5 text-neutral-500 text-lg">
            It is a creative hub where imagination meets craftsmanship to transform ideas into tangible realities. At MeetoU Agency, we specialize in turning conceptual visions into concrete forms, whether it be through design, artistry, or technological innovation.
          </p>
        </div>
      </div>
    </div>
    ...
    <!-- Clients -->
    <div class="relative overflow-hidden pt-4 bg-white">
    ...
    <!-- Works -->
    <div class="max-w-7xl px-4 lg:px-6 lg:px-8 py-12 lg:py-24 mx-auto" id="work">
    ...
    <div class="bg-white">
      <div class="max-w-5xl px-4 xl:px-0 py-10 mx-auto">
        <div class="rounded-3xl shadow-xl border">
      ...
      <div class="max-w-5xl px-4 xl:px-0 py-10 lg:pt-20  mx-auto">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-16 lg:items-center">
          ...
          <div>
            <!-- Heading -->
            <div class="mb-4">
              <h3 class="text-xs font-medium uppercase text-gray-800">
                Steps
              </h3>
            </div>
            <!-- End Heading -->
            ...
            <div class="flex gap-x-5 ms-1">
              <!-- Icon -->
              <div class="relative last:after:hidden after:absolute after:top-8 after:bottom-0 after:start-4 after:w-px after:-translate-x-[0.5px] after:bg-white">
                <div class="relative z-10 size-8 flex justify-center items-center">
                  <span class="flex flex-shrink-0 justify-center items-center size-8 border border-neutral-800 text-gray-800 font-semibold text-xs uppercase rounded-full">
                    1
                  </span>
                </div>
              </div>
              ...
              <div class="grow pt-0.5 pb-8 sm:pb-12">
                <p class="text-sm lg:text-base text-neutral-400">
                  <span class="text-gray-800">Website Development:</span>
                  Static and Dynamic Development
                </p>
              </div>
              <!-- End Right Content -->
            </div>
            ...
            <div class="flex gap-x-5 ms-1">
              ...
              <div class="grow pt-0.5 pb-8 sm:pb-12">
                <p class="text-sm lg:text-base text-neutral-400">
                  <span class="text-gray-800">App Development:</span>
                  Android & iOS.
                </p>
              </div>
              <!-- End Right Content -->
            ...
            <div class="flex gap-x-5 ms-1">
              ...
              <div class="grow pt-0.5 pb-8 sm:pb-12">
                <p class="text-sm md:text-base text-neutral-400">
                  <span class="text-gray-800">Marketing and Promotion:</span>
            ...
            <div class="flex gap-x-5 ms-1">
              ...
              <div class="grow pt-0.5 pb-8 sm:pb-12">
                <p class="text-sm md:text-base text-neutral-400">
                  <span class="text-gray-800">Launch and Optimization:</span>
            ...
            <a class="group inline-flex items-center gap-x-2 py-2 px-4 bg-cyan-600 font-medium text-sm text-white rounded-full focus:outline-none" href="#">
